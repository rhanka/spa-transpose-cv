...
const envSchema = z.object({
  ...
  ADMIN_AUTH_EMAILS: z.string().optional(),
  ADMIN_TOKEN_TTL_MINUTES: z.coerce.number().default(720),
  ADMIN_OTP_TTL_MINUTES: z.coerce.number().default(15),
  WEBAUTHN_RP_ID: z.string().optional(),
  WEBAUTHN_RP_NAME: z.string().default("CV Transpose Backoffice"),
  WEBAUTHN_ORIGIN: z.string().default("http://localhost:5175,http://127.0.0.1:5175,http://localhost:5173,http://127.0.0.1:5173"),
  WEBAUTHN_TIMEOUT_REGISTRATION_MS: z.coerce.number().default(60_000),
  WEBAUTHN_TIMEOUT_AUTHENTICATION_MS: z.coerce.number().default(300_000),
