...
// gemini-3.6-flash). TODO(finops): re-source cost + CO2 per model (see CO2_METHODOLOGY.md).
const PROVIDER_META: Record<ProviderId, LlmProviderConfig> = {
  ...
  gemini: { id: 'gemini', modelId: 'gemini-3.6-flash', label: 'Gemini 3.6 Flash', costPer1MInput: 1.25, costPer1MOutput: 10, co2ePer1kOutput: 8.10 },
