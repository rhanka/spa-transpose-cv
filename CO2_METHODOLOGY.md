...
> **A re-sourcer (swap modeles 2026-09).** Les noms ont ete mis a jour (GPT-5.6 Luna, Claude Sonnet 5, Gemini 3.6 Flash) mais les estimations params / Wh / gCO2e et les couts sont **reportes des modeles precedents** et doivent etre recalcules. Ne pas considerer ces valeurs comme sourcees pour les nouveaux modeles.
...
| **GPT-5.6 Luna** | ~8B | 0.065 | 0.004 | 390 | **1.44** |
| **Claude Sonnet 5** | ~70B | 0.57 | 0.032 | 270 | **8.75** |
| **Command A Reasoning** | ~111B | 0.90 | 0.051 | 390 | **20.0** |
| **Gemini 3.6 Flash** | ~175B | 1.42 | 0.081 | 100 | **8.10** |
...
| GPT-5.6 Luna | ~12g | ~24h LED |
| Gemini 3.6 Flash | ~65g | ~5.4j LED |
| Claude Sonnet 5 | ~70g | ~5.8j LED |
