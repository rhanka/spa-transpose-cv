...
> **A re-sourcer (swap modeles 2026-09).** Les noms ont ete mis a jour (GPT-5.6 Luna, Claude Sonnet 5, Gemini 3.8 Flash) mais les estimations params / Wh / gCO2e et les couts sont **reportes des modeles precedents** et doivent etre recalcules. Ne pas considerer ces valeurs comme sourcees pour les nouveaux modeles.
...
| **Gemini 3.8 Flash** | ~175B | 1.42 | 0.081 | 100 | **8.10** |
